...
[
  { "name": "explore", "numberOfGames": 100000, "alpha": 0.1, "gamma": 0.9, "epsilon": 1.0, "epsilonDecay": 1.0, "epsilonMin": 0.01 },
  { "name": "learn", "numberOfGames": 2000000, "alpha": 0.1, "gamma": 0.9, "epsilon": 1.0, "epsilonDecay": 0.999999, "epsilonMin": 0.01 },
  { "name": "fine-tune", "numberOfGames": 500000, "alpha": 0.1, "gamma": 0.9, "epsilon": 1.0, "epsilonDecay": 1.0, "epsilonMin": 0.01 }
]
EOF
