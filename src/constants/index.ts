...
export const T3AI_NOVICE_MODEL_FILE_NAME = 't3ai-novice.json';
export const T3AI_BEGINNER_MODEL_FILE_NAME = 't3ai-beginner.json';
export const T3AI_LEARNER_MODEL_FILE_NAME = 't3ai-learner.json';
...
export const models = [
  { filename: T3AI_NOVICE_MODEL_FILE_NAME, agentType: AgentType.NOVICE },
  { filename: T3AI_BEGINNER_MODEL_FILE_NAME, agentType: AgentType.BEGINNER },
  { filename: T3AI_LEARNER_MODEL_FILE_NAME, agentType: AgentType.LEARNER }
];
